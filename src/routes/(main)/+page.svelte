	...
	<section>
		...
		<SignedOut>
			...
			<Card.Root class="m-4">
				...
				<Card.Content>
					<p class="font-mono">
						...
						mind. We offer a comprehensive suite of features that empower you to take control of
						your creative journey. 🎨 Whether you're an emerging artist or an established performer,
						our tools are tailored to help you thrive in the digital age. 🌟 With capabilities such
						as creating a professional artist website 🌐, managing social media 📱, and offering
			...
			<Card.Root class="m-4">
				...
				<Card.Content>
					<p class="font-mono">
						We believe in the power of collaboration. That’s why we partner with leading companies
						in the music industry to bring you unparalleled opportunities and experiences. Our
						extensive network ensures you have access to the best resources and support available.
						From distribution to promotion, we provide everything you need to succeed. Our platform
						makes it easy to get your music on all major streaming platforms and digital stores,
						ensuring your tracks are available to listeners everywhere.
					</p>
				</Card.Content>
				<Card.Content>
